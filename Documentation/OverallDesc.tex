...
\begin {itemize}
	...
	\item When the system finds a possible match for a shared ride notifies every User involved &(&the one that joins and the ones who are already in the ride&)& and everyone has to accept. 
